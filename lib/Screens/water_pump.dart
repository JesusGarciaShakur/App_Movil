...
class _WaterPumpState extends State<WaterPump> {
  DatabaseReference fireDb = FirebaseDatabase.instance
      .ref('sensor'); //--> Conexión con la base de datos
  String readFire = "";
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            MaterialButton(
                onPressed: _showTimePicker, child: const Text("Un botón")),
            ...
            const MaterialButton(onPressed: null, child: Text("Guardar"))
          ],
        ),
      ),
    );
  ...
  Row setStateBomb() {
    return Row(
      ...
      children: [
        MaterialButton(
            onPressed: () {
              fireDb.update({"relay": 1});
            },
            child: const Text('Encender')),
        MaterialButton(
            onPressed: () {
              fireDb.update({"relay": 0});
            },
